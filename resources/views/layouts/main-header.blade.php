					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg><span id="noti"></span></a>
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"> 
												<a href="\MarkAsRead_all"> قراءة الكل </a></span>
										</div>
									...
									<div class="main-notification-list Notification-scroll">
										<a class="d-flex p-3 border-bottom" href="{{ Route('markAsRead')}}">
											{{-- href="{{ Route('invioce_details.edit',$notification->data['id'] )}}"> --}}
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="{{ url('/' . $page='invioces') }}"><i class="fas fa-chart-line"></i>الفواتير</a>
									<a class="dropdown-item" href="{{ url('/' . $page='sections') }}"><i class="fas fa-box"></i>الاقسام</a>
									@can('قائمة المستخدمين')<a class="dropdown-item" href="{{ url('/' . $page='users') }}"><i class="bx bx-user-circle"></i>المستخدمين</a>@endcan
									<a class="dropdown-item" href="{{ url('/' . $page='products') }}"><i class="fas fa-cart-arrow-down"></i>المنتجات</a>
