<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				...
				<div class="d-flex mx-auto "> <h1 class="main-logo1 ml-1 mr-0 my-auto tx-28 ">Co<span>mm</span>a</h1><a href="{{ url('/' . $page='home') }}" class="desktop-logo logo-light active"><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="main-logo" alt="logo"></a></div>
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							@can('قائمة الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invioces') }}">قائمة الفواتير</a></li>
							@endcan 
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							@can('تقرير الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='report_invoices') }}">تقرير الفاتورة</a></li>
							@endcan
							@can('تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='report_customers') }}">تقرير العملاء</a></li>
							@endcan
						</ul>
					</li>
					@endcan
