...
@section('title') 
    الاقسام - كومة سوفت وير  لادارة الفواتير
@stop
@section('css')
							...
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    <div class="col-sm-6 col-md-3 col-xl-2">
                                        @can('اضافة قسم')
										<a class="modal-effect btn btn-primary btn-block " data-effect="effect-scale" data-toggle="modal" href="#modaldemo8"><i class="fas fa-plus  ml-2"></i>&nbsp;اضافة قسم</a>
                                        @endcan
									</div>
								</div>
							</div>
